...
#define SC_KEY_RELEASE                0
#define SC_KEY_PRESS                  1
#define SC_KEY_REPEAT                 2

#define SC_BUTTON_RELEASE                0
#define SC_BUTTON_PRESS                  1
#define SC_BUTTON_REPEAT                 2
